            ...
            <tbody>
                @forelse($dataCuti as $cuti)
                    <tr data-tahun="{{ date('Y', strtotime($cuti->tanggal_pengajuan)) }}">
                        ...
                        <td>
                            <span class="status {{ $cuti->status_pengajuan }}">
                                {{ ucfirst($cuti->status_pengajuan) }}
                            </span>
                        </td>
...
function showDetail(nama, jenis, divisi, pengajuan, mulai, selesai, jumlah, status, alasan) {
