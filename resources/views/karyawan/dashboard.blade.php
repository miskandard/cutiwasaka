    ...
    <body>
        ...
        <div class="main-content min-h-screen p-6">
            ...
            <div class="top-card bg-white rounded-xl px-4 md:px-8 py-6 flex justify-between items-center shadow-sm">
                <div class="flex items-center gap-3 md:gap-4">
                    <button type="button" class="hamburger-btn" onclick="toggleSidebar()">
                        <i class="fa-solid fa-bars"></i>
                    </button>
                    <h1 class="text-xl md:text-3xl font-bold text-[#0d1f6b] leading-tight">Beranda Karyawan</h1>
                </div>
            ...
            <div
                class="welcome-bar bg-white mt-4 px-5 py-4 rounded-xl flex justify-between items-center font-bold text-[#0d1f6b] shadow-sm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                ...
                <div
                    class="dashboard-card bg-white rounded-2xl shadow-md p-6 sm:p-8 flex justify-between items-center hover:-translate-y-1 hover:shadow-xl transition-all">
                    <div>
                        <h3 class="text-gray-500 text-sm sm:text-base font-semibold mb-2">Sisa Cuti</h3>
                        <p class="text-3xl sm:text-4xl font-extrabold text-gray-900">{{ $user->sisa_cuti ?? 12 }}</p>
                    </div>
                    <i class="fa-solid fa-users text-4xl sm:text-5xl text-blue-500"></i>
                </div>

                <div
                    class="dashboard-card bg-white rounded-2xl shadow-md p-6 sm:p-8 flex justify-between items-center hover:-translate-y-1 hover:shadow-xl transition-all">
                    <div>
                        <h3 class="text-gray-500 text-sm sm:text-base font-semibold mb-2">Status Pengajuan Terakhir</h3>
                        <p class="text-2xl sm:text-3xl font-extrabold text-gray-900">
                            {{ ucfirst($statusCuti ?? 'Belum Ada') }}</p>
                    </div>
                    <i class="fa-solid fa-clipboard-check text-4xl sm:text-5xl text-green-500"></i>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                ...
                <div
                    class="dashboard-card bg-white rounded-2xl shadow-md p-6 sm:p-8 flex justify-between items-center hover:-translate-y-1 hover:shadow-xl transition-all">
                    <div>
                        <h3 class="text-gray-500 text-sm sm:text-base font-semibold mb-2">Total Cuti Dipakai</h3>
                        <p class="text-3xl sm:text-4xl font-extrabold text-gray-900">{{ $totalDipakai ?? 0 }}</p>
                    </div>
                    <i class="fa-solid fa-calendar-check text-4xl sm:text-5xl text-cyan-400"></i>
                </div>

                <div
                    class="dashboard-card bg-white rounded-2xl shadow-md p-6 sm:p-8 flex justify-between items-center hover:-translate-y-1 hover:shadow-xl transition-all">
                    <div>
                        <h3 class="text-gray-500 text-sm sm:text-base font-semibold mb-2">Pengajuan Pending</h3>
                        <p class="text-3xl sm:text-4xl font-extrabold text-gray-900">{{ $pending ?? 0 }}</p>
                    </div>
                    <i class="fa-solid fa-clock text-4xl sm:text-5xl text-yellow-400"></i>
                </div>

                <div
                    class="dashboard-card bg-white rounded-2xl shadow-md p-6 sm:p-8 flex justify-between items-center hover:-translate-y-1 hover:shadow-xl transition-all sm:col-span-2 lg:col-span-1">
                    <div>
                        <h3 class="text-gray-500 text-sm sm:text-base font-semibold mb-2">Divisi</h3>
                        <p class="text-2xl sm:text-3xl font-extrabold text-gray-900">{{ $user->divisi ?? '-' }}</p>
                    </div>
                    <i class="fa-solid fa-building text-4xl sm:text-5xl text-red-400"></i>
                </div>

                <div
                    class="dashboard-card bg-white rounded-2xl shadow-md p-6 sm:p-8 flex justify-between items-center hover:-translate-y-1 hover:shadow-xl transition-all sm:col-span-2 lg:col-span-3">
                    <div>
                        <h3 class="text-gray-500 text-sm sm:text-base font-semibold mb-2">
                            Tipe Kerja
                        </h3>
                        ...
                        <p class="text-2xl sm:text-3xl font-extrabold text-gray-900">
                            ...
                            -
                            @else
                            {{ $user->tipe_kerja == 'back_office' ? 'Back Office' : 'Operasional' }}
                            @endif
                        </p>
                    </div>

                    <i class="fa-solid fa-briefcase text-4xl sm:text-5xl text-indigo-500"></i>
</div>

            </div>

            
            <div class="table-box bg-white rounded-2xl shadow-md p-4 sm:p-6 mt-8">
                <h2 class="text-xl sm:text-3xl font-bold text-[#0d1f6b] mb-5">
        ...
        <div id="welcomeModal" class="welcome-modal" data-login-id="{{ session('welcome_login_id') }}">
            <div class="welcome-box">
                ...
                <button onclick="closeWelcomeModal()"
                    class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-bold transition">
                    OK
                </button>
            </div>
        </div>
